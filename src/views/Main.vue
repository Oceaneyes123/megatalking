<template>
  <v-app>
    ...
    <v-img src="../assets/bg2.jpg" width="100%" class="text-center pa-3">
      <div class="h3 font-weight-bold white--text mb-5" style="margin-top:80px">
        무조건 듣기만하는 영어 회화?
      </div>
      ...
      <v-container style="max-width:1000px;margin-top:90px">
        <v-card class="rounded-xl" width="100%">
          <v-row class="px-10">
            <v-col cols="12" sm="4">
              <v-card class="pt-10" flat color="#00000000">
                ...
                <div class="caption">화상영어 서비스</div>
              </v-card>
            </v-col>
            <v-col cols="12" sm="4">
          ...
          >
            <v-card
              class="pt-10 pr-10 ml-auto pb-5 rounded-xl"
              width="80%"
              color="#f1f1f1"
            >
              <div
